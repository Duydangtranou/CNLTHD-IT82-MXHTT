"""
Django settings for CNLTHD project.
...
SECRET_KEY = 'django-insecure-1_7&-6e3xerrbc(#0d*r7*&$30vm&8_ws7x$jj=c*o6=1bwd17'
...
WSGI_APPLICATION = 'CNLTHD.wsgi.application'
